...
#----------------Fonction pour récupérer les datas des tickers séléctionnés
def getData(ticker, start_date, end_date=None):
    data = pdr.get_data_yahoo(ticker, start=start_date, end=end_date)
    return data
#---------------------------------------------------------------------------
# import des indices apple, microsoft, amazon, tesla , google des titres qui nous semblent être une valeur sûre
# surtout en période de covid

# travail sur la variable adj_close : prix de clôture des actions apres reversement des dividendes aux actionnaires
def GetTickersData(Sticker_Select,Date_start,date_end=None):
	stock = getData(Sticker_Select, Date_start,date_end)["Adj Close"]
	#plutard implémenter lorsque un le tickers renvoie que des NA, prévenir que le ticker est vide
